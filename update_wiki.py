...
# Formatowanie nowego wpisu z odpowiednimi separatorami
new_entry = f"| {user_id} | {current_date} | {numer_id} | {github_actor} |\n"

# Sprawdzenie, czy plik istnieje i odczytanie zawartości
...
# Wstawienie nowego wpisu na początku tabeli (po nagłówkach)
